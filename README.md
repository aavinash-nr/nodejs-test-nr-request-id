...
```bash
nodejs-layer-config-testing$ sam build
```
...
```bash
nodejs-layer-config-testing$ sam logs -n HelloWorldFunction --stack-name nodejs-layer-config-testing --tail
```
...
```bash
nodejs-layer-config-testing$ cd hello-world
...
```bash
sam delete --stack-name nodejs-layer-config-testing
```
